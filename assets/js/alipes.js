...
$(".main-menu__list a").on("click", function (e) {
  ...
  $(document).ready(function() {
    ...
    // Function to set a timeout for showing the modal
    function setModalTimeout() {
        if (!formSubmitted) {
            console.log("Setting modal timeout...");
            modalTimeout = setTimeout(showModal, 15000); // Show modal again after 15 seconds
        }
    }

    // Initial call to show modal after 10 seconds
    ...
    $('#advancedModal').on('hidden.bs.modal', function () {
        console.log("Modal hidden, setting new timeout...");
        setModalTimeout();
    });

    // Handle modal show event to clear any existing timeout
    $('#advancedModal').on('shown.bs.modal', function () {
        console.log("Modal shown, clearing existing timeout...");
...
$(document).ready(function() {
  ...
  function switchTab(targetTab) {
      ...
      $("[data-tab='" + targetTab + "']").addClass("active-btn");
